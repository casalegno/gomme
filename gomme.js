...
$(document).ready(function() {
        ...
        if (input != '') {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    console.log('Gommejs Il risultato dell\'oggetto: ');
    ...
    $(document)
        ...
        //in modifica gomme se clicco due volte sul codice dell'articolo mi apre la ricerda dello stesso
...
//     let filtro = document.getElementById("filtra").value;
...
//     if (filtro != '') {
//         //svuoto la sezione dei risultati
//         res.innerHTML = "Sto cercando i risultati...";
//         //$('#result').html("Sto cercando i risultati...");
//         //eseguo la chiamata ajax
...
/* function print_catalogo(obj){ 
    ...
    for (var item of obj.res){
        ...
        res.innerHTML +=`<div class="articolo" data-code="${item.articolo}"><p class="immagine"><img alt="${item.articolo}" src="./cropped/${item.articolo}.jpg"></p>
            <p class="ads">Peso:${item.peso}    Quantita:${item.quantita}</p><p class="desc">${item.descrizione}</p>
            <p class="data">${data[0]}<br /> €: ${item.prezzo}</p><i data-code="${item.articolo}" class="iconinart fa fa-pencil-square-o"></i></div>`;


        //     $('#result').append(
        //     '<div class="articolo">' +
        //     '<p class="immagine"><span class="codice">' + item.articolo + '</span><img alt="' + item.articolo + '" src="./cropped/' + item.articolo + '.jpg"></p>' +
